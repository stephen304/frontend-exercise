(function() {
  DoubleClickDetector = function() {
    ...
    let storedData = LOCALSTORAGEENABLED && localStorage.getItem('clickDetectorData')
    ...
    dcd.ping = function() {
      ...
      LOCALSTORAGEENABLED && localStorage.setItem('clickDetectorData', JSON.stringify(dcd.data));
    }
    dcd.clear = function() {
      ...
      // Clear local storage
      LOCALSTORAGEENABLED && localStorage.removeItem('clickDetectorData');
    }
  }
})()
